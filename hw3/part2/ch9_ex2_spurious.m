...
x1 = [2.5; 2.5]; % Spurious attractor coordinates
...
for i=1:nb_gridpoints
    for j=1:nb_gridpoints
        ...
        local_vec = x-x1;     % distance to spurious attractor
        [L, E, M] = spurious_modulation(local_vec, r, p);
...
plot_ds_modulation(X, Y, x_dot, y_dot, x1, ...
    'Modulated DS with spurious attractor', 'streamslice', x1, plot_speed);
